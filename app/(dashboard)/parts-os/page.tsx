...
export default function PartsOSPage() {
  ...
  function handleSave() {
    setPanelOpen(false);
    setForm({ name: "", supplier_id: "", barcode: "", serial_number: "", qty_in_stock: "", min_threshold: "", cost_price: "", sale_price: "" });
  }
  ...
  return (
    <>
      ...
      <RightPanel open={panelOpen} onClose={() => setPanelOpen(false)} title="New Outsourced Stock Item">
        <div style={s.form}>
...
function PartsList({ onAdd }: { onAdd: () => void }) {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <p style={{ color: "var(--text-secondary)", fontSize: 14 }}>No outsourced parts yet.</p>
      <button
        onClick={onAdd}
        style={{
